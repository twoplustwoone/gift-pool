...
INSERT INTO "new_WishlistItem" ("categoryId", "createdAt", "id", "note", "ownerId", "title", "type", "updatedAt", "url") SELECT "categoryId", "createdAt", "id", "note", "ownerId", "title", "type", "updatedAt", "url" FROM "WishlistItem";
