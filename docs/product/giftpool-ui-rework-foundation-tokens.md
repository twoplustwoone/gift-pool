...
| `--background-muted`            | `#F0DBD0` (deepened from `#FAEBE5` in the Home contrast/elevation pass — the original sat within 4 lightness points of `--background`/`--card`) | Low-emphasis grouping                                                                                                                                                                                                                  |
