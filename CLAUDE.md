...
- Admin dashboard at `/admin/analytics` (DAU/WAU/MAU, activation funnel, weekly retention, notification opt-out matrix, link-enrichment health section, event count tables)
